...
minimizeButton.MouseButton1Click:Connect(function()
    ...
    Tween(main, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = Opened and Info.Size or UDim2.new(Info.Size.X.Scale, Info.Size.X.Offset, 0, 30)})
end)
...
function insidetoggle:Set(bool)
    ...
    elseif Toggled and not EditOpened then
        TweenService:Create(toggleFrame, TweenInfo.new(.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = library.Theme.Accent}):Play()
    end
